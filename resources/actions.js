/* global content videoIdAndLength videoIds videoLengths alert loadedAllVideos confirm Blob loadNextVideo */
/* exported loadData */
...
function submitActions () {
  ...
  if (!loadedAllVideos) {
    if (confirm('Submit list of actions and go to next video?')) {
      ...
      addedActionsList = document.getElementsByClassName('addedActionsList')[0];
